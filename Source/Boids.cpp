...
// DesktopView gets screen resolution of PC running the program
sf::VideoMode DesktopView = sf::VideoMode::getDesktopMode();
const int window_height = DesktopView.height;
const int window_width = DesktopView.width;
